...
const data = [
  {
    ...
    fields: {
      ...
      featured: false,
      description:
        'The hotel room is spacious and well-lit, with large windows that offer a breathtaking view of the city skyline. The room is tastefully decorated with elegant furnishings, including a comfortable king-sized bed with plush pillows and soft bedding. A work desk and a cozy armchair provide a comfortable workspace and relaxation area, while the room also features a flat-screen TV, a mini fridge, and a coffee maker. The ensuite bathroom is modern and clean, with a walk-in shower, fluffy towels, and complimentary toiletries. Overall, the hotel room is designed to provide comfort and convenience for a relaxing stay.',
      extras: [
